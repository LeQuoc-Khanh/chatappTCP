    ...
    public partial class Client : Form
    {
                ...
                try
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            if (data != null && data.TryGetValue("status", out string? status) && status.Equals("authorized"))
                            {
                                Connected(true);
                            }
                        }
                        ...
                        {
                            Log(ErrorMsg("JSON parse error: " + ex.Message));
                        }
        ...
        private void connectButton_Click(object sender, EventArgs e)
        {
            ...
            else if (client == null || !client.IsAlive)
            {
                ...
                {
                    Log(SystemMsg("Invalid IP or input data."));
                }
            }
        }
